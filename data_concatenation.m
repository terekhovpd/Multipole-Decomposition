...
norm_length       = dlmread  (strcat('dim_value',num2str(n),'.dat')); %Пишем файлы с нанометрами и прочим бла бла бла
...
%Сортируем все остальные данные в соответствии сортировкой вектора высот
mask 	= mask(I,:);
Px 		= Px (I,:);	
Py 		= Py (I,:);	
Pz 		= Pz (I,:);	
